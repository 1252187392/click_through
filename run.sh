...
echo 'MLP'
echo 'woe'
time python MLP/mlp_model.py woe > infos/woe_MLP.info
echo 'hash'
time python MLP/mlp_model.py hash > infos/hash_MLP.info
echo 'woe onehot'
time python MLP/mlp_model.py woe onehot > infos/woe_onehot_MLP.info
echo 'hash onehot'
time python MLP/mlp_model.py hash onehot > infos/hash_onehot_MLP.info
